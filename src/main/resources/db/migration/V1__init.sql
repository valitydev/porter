...
(
    ...
    CONSTRAINT notification_to_party_fk FOREIGN KEY (party_ref_id) REFERENCES notify.party (id)
);
...
CREATE INDEX notification_party_ref_id_idx ON notify.notification (party_ref_id);
